...
export default function TransactionCards() {
  ...
  const primary = grey[50]; // Define the primary color for the component
  ...
  // Function to start editing a specific field (category or note) of a transaction
  ...
  return (
    // Wrap the component in a ThemeProvider to apply the custom theme
    <ThemeProvider theme={localTheme}>
      <Box className="transaction-container">
        ...
        {transactions.map(
          (
            transaction,
            index // Map through the transactions data
          ) => (
            <Card
            ...
            >
              ...
              >
                ...
                <Box sx={{ width: "40px" }}>
                  <IconButton // Toggle the row expansion
